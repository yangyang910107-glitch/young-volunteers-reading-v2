...
function decorateGuestPractice(){
  ...
  if($('feedback-status'))$('feedback-status').textContent=personal.sent?'Your practice check is saved. Revise your own practice answer below.':'Practice the peer check. Your feedback will not be sent to the class.';
