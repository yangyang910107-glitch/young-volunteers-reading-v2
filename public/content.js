(function(root){const QUESTIONS=[
  ...
  4,
  1
],TASK_LABELS='abcdefhi',GROUP_LABELS='abcdef',EXIT_LABELS='hi';if(typeof module!=='undefined')module.exports={QUESTIONS,KEYS,GROUP_KEY_IDS,TASK_LABELS,GROUP_LABELS,EXIT_LABELS};else Object.assign(root,{QUESTIONS,KEYS,GROUP_KEY_IDS,TASK_LABELS,GROUP_LABELS,EXIT_LABELS});})(typeof window!=='undefined'?window:globalThis);
